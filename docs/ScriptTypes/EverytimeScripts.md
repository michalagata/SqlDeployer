...
---
# Everytime Scripts
Everytime scripts are scripts that are run everytime sqldep runs, regardless of changes.  

If you name your file with `.EVERYTIME.`, sqldep will run that file everytime, regardless of changes.  For example, if you name a file **Something.EVERYTIME.sql** or **EVERYTIME.something.sql**, sqldep will run that file on each migration. 
