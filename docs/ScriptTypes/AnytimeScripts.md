...
Anytime scripts are scripts that are run anytime they have changes. That means sqldep automatically detects new files and changes in files and runs when it finds changes.
